INSERT INTO BUILDER.ROLE (ID , NAME) VALUES ('1', 'admin');
...
INSERT INTO builder.user (NAME, PASSWORD, ROLE_ID, EMAIL) VALUES ( 'Admin', 'password', '1', 'admin@gmail.com' );
...
// to do complete filling initial data
COMMIT;